...
description: "Aprende a invitar compañeros a Seked, asignar roles de Administrador, Presupuestador o Visualizador y gestionar los permisos de tu equipo."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Presupuestador" icon="pen-ruler" href="/equipo/usuarios-y-roles">
  ...
  <Card title="Visualizador" icon="eye" href="/equipo/usuarios-y-roles">
    Solo puede consultar los proyectos y presupuestos a los que tiene acceso, sin posibilidad de editar ni exportar. Ideal para directores de obra, gerencia o clientes internos que necesitan seguimiento sin intervenir.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Selecciona el rol para cada usuario">
    ...
    - **Administrador**: para responsables de equipo y gestores de la cuenta.
    - **Presupuestador**: para técnicos, estimadores y cualquier persona que vaya a crear o editar presupuestos.
    - **Visualizador**: para directivos, clientes internos u otras personas que solo necesitan consultar el trabajo.
