...
<Accordion title="Plan de trabajo">
  El avance de las 13 fases del estudio se refleja en el documento `Plan de trabajo.md`, dentro de la carpeta `.seked`, cada vez que cambia el estado de la obra.
</Accordion>
